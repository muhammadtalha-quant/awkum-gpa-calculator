...
const PredictiveDashboard: React.FC<Props> = ({ theme }) => {
    ...
    return (
        <div className={`p-8 rounded-[2.5rem] border ${theme.border} bg-white/5 backdrop-blur-md animate-in slide-in-from-bottom-4 duration-500`}>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-10">
                ...
                <div className="flex items-center gap-4 bg-black/10 p-2 rounded-2xl border border-white/5">
                    <label className="text-[9px] font-black uppercase tracking-widest opacity-40 ml-4">Future Credits</label>
                    <input
                        type="number"
                        min="0"
                        max="120"
            ...
            <div className="flex flex-col items-center justify-center py-6 text-center border-t border-white/5 relative">
                ...
                <p className="mt-6 text-[10px] font-bold opacity-40 max-w-sm leading-relaxed">
